<div class="header animated fadeInDown">
  <div class="site_title_container">
    ...
    <div class="description">
      <p class="sub_title">feiyang.</p>
      <div class="my_socials">
<#--        <#if settings.github??>-->
          <a href="mailto:i520gfy@gmail.com" title="mail"><i class="remixicon-mail-send-fill"></i></a>
          <a href="https://github.com/feiyangbeyond" title="github" target="_blank"><i class="remixicon-github-fill"></i></a>
<#--        </#if>-->
<#--        <#if settings.twitter??>-->
